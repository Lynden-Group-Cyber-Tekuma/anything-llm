...
// GitHubBranchSelection sub-component
const GitHubBranchSelection = defineComponent({
  name: 'GitHubBranchSelection',
  props: {
    repo: String,
    accessToken: String
  },
  ...
  template: `
    <div class="flex flex-col w-60">
      <div class="flex flex-col gap-y-1 mb-4">
        <label class="text-white text-sm font-bold">Branch</label>
        <p class="text-xs font-normal text-theme-text-secondary">
          {{ loading ? t('connectors.github.branch') : t('connectors.github.branch_explained') }}
        </p>
      </div>
      <select
        name="branch"
  ...
  template: `
    ...
    >
      <div class="gap-x-2 flex items-center">
        ...
        <p class="text-sm">
          <span v-html="t('connectors.github.token_information')" />
          <br />
          <br />
          <a
...
export { GitHubBranchSelection, PATAlert, PATTooltip, TagsInput }
</script>
