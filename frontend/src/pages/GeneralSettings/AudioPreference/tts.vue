...
import BrowserNative from '@/components/TextToSpeech/BrowserNative/index.vue'
import OpenAiTTSOptions from '@/components/TextToSpeech/OpenAiOptions/index.vue'
import ElevenLabsTTSOptions from '@/components/TextToSpeech/ElevenLabsOptions/index.vue'
import PiperTTSOptions from '@/components/TextToSpeech/PiperTTSOptions/index.vue'
import OpenAiGenericTTSOptions from '@/components/TextToSpeech/OpenAiGenericOptions/index.vue'
...
const PROVIDERS = [
  ...
  },
  {
    ...
    options: OpenAiGenericTTSOptions,
    description:
...
const selectedProvider = ref(props.settings?.TextToSpeechProvider || 'native')
...
const handleSubmit = async (e) => {
  ...
  const data = { TextToSpeechProvider: selectedProvider.value }
