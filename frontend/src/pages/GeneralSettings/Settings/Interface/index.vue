<template>
  <div class="w-screen h-screen overflow-hidden bg-theme-bg-container flex">
    ...
    >
      <div class="flex flex-col w-full px-1 md:pl-6 md:pr-[86px] md:py-6 py-16">
...
import LanguagePreference from '../components/LanguagePreference/index.vue'
import ThemePreference from '../components/ThemePreference/index.vue'
import { MessageDirection } from '../components/MessageDirection/index.vue'
